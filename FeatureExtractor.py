...
class FeatureExtractor(object):
    @classmethod
    def get_features(self, image, color_space='RGB', spatial_size=(32, 32),
        ...
        feature_image = self.change_color_space(image, color_space=color_space)
    ...
    def search_windows(self, img, windows, clf, scaler, color_space='RGB',
        ...
        for window in windows:
            ...
            features = FeatureExtractor.get_features(test_img, color_space=color_space,
